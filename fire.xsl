...
<xsl:template match="pokemon">
    <xsl:value-of select="//pokemon[type='fire']" /> (<xsl:value-of select="//pokemon[type='fire']" />): <xsl:apply-templates select="//pokemon[type='fire']" /><xsl:text>
</xsl:text>
</xsl:template>
...
<xsl:template match="pokemon">
    <tr>
      <td><xsl:value-of select="//pokemon[type='fire']" />(<xsl:value-of select="//pokemon[type='fire']" />)</td>
      <td><xsl:apply-templates select="//pokemon[type='fire']" /></td>
    </tr>
</xsl:template>
-->
