...
<xsl:template match="pokemon">
    <xsl:value-of select="//pokemon[@generation='1']" /> (<xsl:value-of select="//pokemon[@generation='1']" />): <xsl:value-of select="//pokemon[@generation='1']" /> | 
</xsl:template>
...
<xsl:template match="pokemon">
    <tr>
      <td><xsl:value-of select="//pokemon[@generation='1']" />(<xsl:value-of select="//pokemon[@generation='1']" />)</td>
      <td><xsl:value-of select="//pokemon[@generation='1']" /></td>
    </tr>
</xsl:template>
-->
